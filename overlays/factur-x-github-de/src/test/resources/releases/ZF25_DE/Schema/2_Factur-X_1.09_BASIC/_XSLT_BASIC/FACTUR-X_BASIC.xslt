...
<xsl:choose>
    ...
    <xsl:variable name="codeValue11" select="@schemeID"></xsl:variable>
...
<xsl:choose>
    ...
    <xsl:variable name="codeValue14" select="@schemeID"></xsl:variable>
...
<xsl:choose>
    ...
    <xsl:variable name="codeValue25" select="@format"></xsl:variable>
